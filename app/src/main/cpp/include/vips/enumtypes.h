...
VIPS_API
GType vips_sdf_shape_get_type(void);
...
VIPS_API
GType vips_foreign_saveable_get_type(void);
#define VIPS_TYPE_FOREIGN_SAVEABLE (vips_foreign_saveable_get_type())
VIPS_API
GType vips_foreign_coding_get_type(void);
...
VIPS_API
GType vips_foreign_pdf_page_box_get_type(void);
